...
class wizard_UI():
    def __init__(self,root,scrollable_frame_cubeview,scrollable_frame_model, canvasmodel,tabletoshow,firstlistwidg,keycube,succintdf,obj_df,rowname,columnname):
